...
def test_vacancy_comparison():
    vacancy1 = Vacancy("Python Developer", "https://hh.ru/vacancy/123456", 100000, "Требования: опыт работы от 3 лет...")
    vacancy2 = Vacancy("Java Developer", "https://hh.ru/vacancy/654321", 120000, "Требования: опыт работы от 5 лет...")
    assert vacancy1 < vacancy2
    assert not (vacancy1 > vacancy2)
    assert not (vacancy1 == vacancy2)

def test_none_salary():
    vacancy = Vacancy("Python Developer", "https://hh.ru/vacancy/123456", None, "Требования: опыт работы от 3 лет...")
